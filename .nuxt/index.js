...
import nuxt_plugin_plugin_b3e05f82 from 'nuxt_plugin_plugin_b3e05f82' // Source: ./components/plugin.js (mode: 'all')
...
import nuxt_plugin_vuesax_2c3217c6 from 'nuxt_plugin_vuesax_2c3217c6' // Source: ../plugins/vuesax.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"GS Studio - Agência Especializada em Design, Marketing e Tecnologia","htmlAttrs":{"lang":"pt-br"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Descrição da GS Studio"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.svg"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_b3e05f82 === 'function') {
    await nuxt_plugin_plugin_b3e05f82(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_6e3121d5 === 'function') {
    await nuxt_plugin_axios_6e3121d5(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_vuesax_2c3217c6 === 'function') {
