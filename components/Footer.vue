...
<section class="py-3 py-md-5 py-xl-6 py-xxl-7 text-left">
    ...
    <div class="row gy-3">
      <div class="col-6 col-md-3">
        <div class="link-wrapper ">
          <h4 class="mb-3 fw-bold fs-6">Serviços</h4>
      ...
      <div class="col-6 col-md-3">
        <div class="link-wrapper">
          <h4 class="mb-3 fw-bold fs-6">Soluções</h4>
          <ul class="m-0 list-unstyled">
            <li class="mb-1">
              <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                Otimização SEO
      ...
      <div class="col-6 col-md-3">
        <div class="link-wrapper mb-3 mb-xl-4">
          <h4 class="mb-3 fw-bold fs-6">Aprenda conosco</h4>
          <ul class="m-0 list-unstyled">
            <li class="mb-1">
              <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                AI
  ...
  <h4 class="mb-3 fw-bold fs-6">Conecte com a gente</h4>
    ...
    <li>
      <a class="d-flex align-items-center justify-content-center p-1 bg-dark rounded link-light link-opacity-75-hover" href="#!">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
          <path d="M8 0C5.33 0 5.07.01 4.32.03c-.74.03-1.25.15-1.7.32a3.454 3.454 0 0 0-1.25.82 3.454 3.454 0 0 0-.82 1.25c-.17.45-.29.96-.32 1.7-.02.75-.03 1.01-.03 2.68s.01 1.93.03 2.68c.03.74.15 1.25.32 1.7.2.53.49.99.82 1.25.27.33.72.61 1.25.82.45.17.96.29 1.7.32.75.02 1.01.03 2.68.03s1.93-.01 2.68-.03c.74-.03 1.25-.15 1.7-.32.53-.2.99-.49 1.25-.82.33-.27.61-.72.82-1.25.17-.45.29-.96.32-1.7.02-.75.03-1.01.03-2.68s-.01-1.93-.03-2.68c-.03-.74-.15-1.25-.32-1.7a3.454 3.454 0 0 0-.82-1.25 3.454 3.454 0 0 0-1.25-.82c-.45-.17-.96-.29-1.7-.32C9.93.01 9.67 0 8 0zm0 1.44c1.48 0 1.72.01 2.33.03.57.02.87.09 1.07.16.26.09.44.2.65.41.21.21.32.39.41.65.07.2.14.5.16 1.07.02.61.03.85.03 2.33s-.01 1.72-.03 2.33c-.02.57-.09.87-.16 1.07-.09.26-.2.44-.41.65-.21.21-.39.32-.65.41-.2.07-.5.14-1.07.16-.61.02-.85.03-2.33.03s-1.72-.01-2.33-.03c-.57-.02-.87-.09-1.07-.16a1.667 1.667 0 0 1-.65-.41 1.667 1.667 0 0 1-.41-.65c-.07-.2-.14-.5-.16-1.07-.02-.61-.03-.85-.03-2.33s.01-1.72.03-2.33c.02-.57.09-.87.16-1.07.09-.26.2-.44.41-.65.21-.21.39-.32.65-.41.2-.07.5-.14 1.07-.16.61-.02.85-.03 2.33-.03zm0 2.163a3.892 3.892 0 1 0 0 7.783 3.892 3.892 0 0 0 0-7.783zm0 1.44a2.451 2.451 0 1 1 0 4.902 2.451 2.451 0 0 1 0-4.902zm4.94-.82a.927.927 0 1 1 0 1.855.927.927 0 0 1 0-1.855z"/>
        </svg>
      </a>
    </li>
    <li>
    ...
    <li>
      <a class="d-flex align-items-center justify-content-center p-1 bg-dark rounded link-light link-opacity-75-hover" href="#!">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-behance" viewBox="0 0 16 16">
          <path d="M8.42 6.644c.95 0 1.528.506 1.528 1.269 0 .935-.594 1.301-1.42 1.301H7.05V6.644h1.37zM7.055 9.713h1.543c.318 0 1.143 0 1.143 1.069 0 .709-.482 1.094-1.143 1.094H7.055V9.713zM6.332 4v8h3.106c1.32 0 2.416-.924 2.416-2.35 0-1.462-.993-2.241-1.696-2.326v-.03c.745-.168 1.266-.864 1.266-1.68C11.424 4.803 10.415 4 9.215 4H6.332zM16 8.008c0-2.206-1.646-4.008-3.852-4.008-2.211 0-3.855 1.796-3.855 4.008 0 2.209 1.641 4.008 3.855 4.008 1.623 0 2.951-.916 3.471-2.313h-1.35c-.246.53-.913.896-1.703.896-1.006 0-1.797-.674-1.997-1.667H16c.003-.11.01-.218.01-.33zm-5.303-.57c.12-.91.866-1.63 1.824-1.63.955 0 1.693.72 1.814 1.63H10.697zm1.822 4.133H11.74c-.384 0-.77-.14-1.032-.415-.264-.277-.409-.635-.429-1.035h3.457c.008.048.022.092.026.14.054.482-.035.963-.248 1.364-.207.395-.535.733-.956.946-.197.096-.41.155-.63.155z"/>
        </svg>
      </a>
    </li>
    <li>
      <a class="d-flex align-items-center justify-content-center p-1 bg-dark rounded link-light link-opacity-75-hover" href="#!">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16">
          <path d="M8 0a8 8 0 0 0-2.5 15.56c-.035-.299-.065-.757.013-1.084.07-.303.45-1.925.45-1.925s-.114-.229-.114-.567c0-.531.308-.929.692-.929.326 0 .482.244.482.536 0 .326-.208.812-.316 1.263-.09.38.193.688.574.688.688 0 1.218-.726 1.218-1.775 0-.926-.666-1.575-1.618-1.575-1.102 0-1.748.826-1.748 1.68 0 .326.127.675.287.865.032.038.037.071.028.109-.033.126-.108.39-.123.446-.019.071-.076.097-.145.071-.446-.18-.726-.73-.726-1.346 0-.956.78-2.1 2.325-2.1 1.225 0 2.16.872 2.16 2.036 0 1.21-.768 2.188-1.831 2.188-.358 0-.695-.185-.81-.404l-.222.847c-.08.303-.296.683-.441.915.332.103.683.159 1.049.159 2.283 0 4.137-1.85 4.137-4.137C12.136 2.873 10.145 0 8 0z"/>
        </svg>
      </a>
    </li>
  </ul>
